...
cp -rf /data/projects/dknr-daikin/package.json /data/package.json
cp -rf /data/projects/dknr-daikin/data/settings.js /data/settings.js
cp -rf /data/projects/dknr-daikin/data/.config.projects.json /data/.config.projects.json
cp -rf /data/projects/dknr-daikin/data/admin.png /data/admin.png
