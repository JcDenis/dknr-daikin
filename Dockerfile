...
LABEL org.opencontainers.image.authors="Jean-Christian Paul Denis" \
      org.opencontainers.image.source="https://github.com/JcDenis/dknr-daikin" \
...
RUN mkdir -p /data/projects/dknr-daikin

# Clone repository
RUN git clone ${DKNR_REPOSITORY} /data/projects/dknr-daikin
